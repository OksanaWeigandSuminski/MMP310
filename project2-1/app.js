...
function loadNextQuestion() {
	...
	const question = createElement('h2', 'question',  "Which sea creature has three hearts?");
	questionContainer.appendChild(question);

	const answers = createElement('div', 'answers');
	questionContainer.appendChild(answers);

	const option1 = createElement('div', 'option', 'Horseshoe Crab');
	const option2 = createElement('div', 'option', 'Sea Star');
	const option3 = createElement('div', 'option', 'Octopus');
